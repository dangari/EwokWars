...
namespace EwokWars.Levels.HUD
{
    class Debug : HUD
    {
        ...
        {
            hudText[HUDTextDirectory.POSITION] = new HUD_Text("Position: " + heroRef.Pos, 5, 65, Color.White, Color.Black);
        ...
        public override void Initialize(Viewport viewport, Objects.Hero hero, Room activeRoom)
        {
            ...
            hudText.Add(HUDTextDirectory.POSITION, new HUD_Text("Position: " + hero.Pos, 5, 65, Color.White, Color.Black));
            hudText.Add(HUDTextDirectory.KEY_INFO_1, new HUD_Text("Press [ESC] to pause", 5, 85, Color.White, Color.Black));
            hudText.Add(HUDTextDirectory.DBG_INFO_1, new HUD_Text("This is our debug HUD", 5, viewport.Height - 25, Color.White, Color.Black));
        }
    }
}
